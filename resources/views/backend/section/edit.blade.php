				...
				<div class="card-body pt-5">
					<form id="kt_ecommerce_settings_general_form" class="form" action="javascript:void(0);" onsubmit="saveData()";>
							...
							<div class="col col col-md-4">
								<div class="fv-row mb-7">
									...
									<select id="pageselect" class="form-control">
										<option value="home"@if($data->page == "home") selected  @endif>Home</option>
										<option value="service" @if($data->page == "service") selected  @endif>Service</option>
										<option value="other"  @if($data->page == "other") selected  @endif>Other</option>
									</select>
									<div class="validation-div" id="val-pageselect"></div>
								</div>
							</div>
						...
						<div class="row">
							<div class="col-md-6">
								<div class="position-relative form-group">
									...
									<img src="{{asset($data->image)}}" height="80" width="80">
						...
						<div class="row">
							<div class="col-md-6">
								<div class="position-relative form-group">
									<label for="description" class="">Video</label>
									<input type="file" class="form-control form-control-solid" id="video"/>
						...
						<div class="row">
							<div class="col-md-6">
								<div class="position-relative form-group">
									<label for="description" class="">Mobile Video</label>
									<input type="file" class="form-control form-control-solid" id="mobile_video"/>
									<video width="120" controls>
									<source src="{{asset($data->mobile_video)}}" type="video/mp4">
									<source src="mov_bbb.ogg" type="video/ogg">
									Your browser does not support HTML video.
									</video>
									<div class="validation-div" id="val-video"></div>
						...
						<div class="row">
							<div class="col-md-6">
								<div class="position-relative form-group">
									...
									<input type="text" class="form-control form-control-solid" value="{{$data->link}}" id="link"/>
...
<script>
	...
	function saveData(){
		...
		data.append('video',jQuery('#video')[0].files[0]);
		data.append('mobile_video',jQuery('#mobile_video')[0].files[0]);
		data.append('link', $('#link').val());
		data.append('page', $('#pageselect option:selected').val());
