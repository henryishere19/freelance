	...
	<div class="toolbar" id="kt_toolbar">
		<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
			<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
				<h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Press-Release</h1>
				...
				<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
					...
					<li class="breadcrumb-item text-muted"><a href="{{ route('faqs.index') }}" class="text-muted text-hover-primary">Company</a></li>
				...
				<div class="card-body pt-5">
					<form id="kt_ecommerce_settings_general_form" class="form" action="javascript:void(0);" onsubmit="saveData()";>
						<div class="row">
							...
							<div class="col col col-md-4">
								<div class="fv-row mb-7">
									...
									<input type="text" class="form-control form-control-solid" id="link" value="{{$data->link}}"/>
						...
						<div class="row">
							<div class="col-md-6">
								<div class="position-relative form-group">
									...
									<img src="{{asset($data->image)}}" height="150px" width="150px">
								</div>
							</div>
						</div>
						...
						<div class="d-flex justify-content-end">
							<a class="btn btn-light me-3" href="{{route('pressrelease.index')}}">Cancel</a>
...
<script>
	...
	function saveData(){
		...
		var response = adminAjax('{{route("ajax.store.pressrelease")}}', data);
