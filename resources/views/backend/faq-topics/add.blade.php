	...
	<div class="toolbar" id="kt_toolbar">
		<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
			<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
				<h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Create FAQ Topics</h1>
				...
				<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
					...
					<li class="breadcrumb-item text-muted"><a href="{{ route('faq-topics.index') }}" class="text-muted text-hover-primary">FAQ Topics</a></li>
				...
				<div class="card-body pt-5">
					<form id="kt_ecommerce_settings_general_form" class="form" action="javascript:void(0);" onsubmit="saveData()";>
						...
						<div class="d-flex justify-content-end">
							<a class="btn btn-light me-3" href="{{route('faq-topics.index')}}">Cancel</a>
...
<script>
	...
	function saveData(){
		...
		var response = adminAjax('{{route("ajax.store.faq.topic")}}', data);
